...
docker build . --rm \
  ...
  -f Containerfile \
  -t ${image_repo}/hive:v3.1.3-skoll-2608.07
```
...
|---------|-----------------------|-----------------|----------|----------|---------|---------|
| skoll   | v3.1.3-skoll-2608.07  | zulu-openjdk    |  21-jdk  | 2.46.21  |  3.4.1  | 42.7.13 |
| ymir    | v3.1.3-ymir-2605.13   | zulu-openjdk    |  21-jdk  | 2.41.31  |  3.4.1  | 42.7.5  |

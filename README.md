...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/409/trino-cli-409-executable.jar)
```
...
The current deployment has been tested with [trino-409](https://repo1.maven.org/maven2/io/trino/trino-jdbc/409/trino-jdbc-409.jar).

...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/417/trino-cli-417-executable.jar)
```
...
The current deployment has been tested with [trino-417](https://repo1.maven.org/maven2/io/trino/trino-jdbc/417/trino-jdbc-417.jar).

...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/418/trino-cli-418-executable.jar)
```
...
The current deployment has been tested with [trino-418](https://repo1.maven.org/maven2/io/trino/trino-jdbc/418/trino-jdbc-418.jar).

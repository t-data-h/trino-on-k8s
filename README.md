...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/402/trino-cli-402-executable.jar)
```
...
The current deployment has been tested with [trino-402](https://repo1.maven.org/maven2/io/trino/trino-jdbc/402/trino-jdbc-402.jar).

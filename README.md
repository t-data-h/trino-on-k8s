...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/391/trino-cli-391-executable.jar)
```
...
The current deployment has been tested with [trino-391](https://repo1.maven.org/maven2/io/trino/trino-jdbc/391/trino-jdbc-391.jar).

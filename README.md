...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/440/trino-cli-440-executable.jar)
```
...
The current deployment has been tested with [trino-440](https://repo1.maven.org/maven2/io/trino/trino-jdbc/440/trino-jdbc-440.jar).

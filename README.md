...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/455/trino-cli-455-executable.jar)
```
...
The current deployment has been tested with [trino-455](https://repo1.maven.org/maven2/io/trino/trino-jdbc/455/trino-jdbc-455.jar).

...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/451/trino-cli-451-executable.jar)
```
...
The current deployment has been tested with [trino-451](https://repo1.maven.org/maven2/io/trino/trino-jdbc/451/trino-jdbc-451.jar).

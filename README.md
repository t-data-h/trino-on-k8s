...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/390/trino-cli-390-executable.jar)
```
...
The current deployment has been tested with [trino-390](https://repo1.maven.org/maven2/io/trino/trino-jdbc/390/trino-jdbc-390.jar).

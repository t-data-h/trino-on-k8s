...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/441/trino-cli-441-executable.jar)
```
...
The current deployment has been tested with [trino-441](https://repo1.maven.org/maven2/io/trino/trino-jdbc/441/trino-jdbc-441.jar).

...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/395/trino-cli-396-executable.jar)
```
...
The current deployment has been tested with [trino-396](https://repo1.maven.org/maven2/io/trino/trino-jdbc/396/trino-jdbc-396.jar).

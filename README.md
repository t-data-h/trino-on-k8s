...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/435/trino-cli-435-executable.jar)
```
...
The current deployment has been tested with [trino-435](https://repo1.maven.org/maven2/io/trino/trino-jdbc/435/trino-jdbc-435.jar).

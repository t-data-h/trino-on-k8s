...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/397/trino-cli-397-executable.jar)
```
...
The current deployment has been tested with [trino-397](https://repo1.maven.org/maven2/io/trino/trino-jdbc/397/trino-jdbc-397.jar).

...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/414/trino-cli-414-executable.jar)
```
...
The current deployment has been tested with [trino-414](https://repo1.maven.org/maven2/io/trino/trino-jdbc/414/trino-jdbc-414.jar).

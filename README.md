...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/399/trino-cli-399-executable.jar)
```
...
The current deployment has been tested with [trino-399](https://repo1.maven.org/maven2/io/trino/trino-jdbc/399/trino-jdbc-399.jar).

...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/458/trino-cli-458-executable.jar)
```
...
The current deployment has been tested with [trino-458](https://repo1.maven.org/maven2/io/trino/trino-jdbc/458/trino-jdbc-458.jar).

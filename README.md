...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/419/trino-cli-419-executable.jar)
```
...
The current deployment has been tested with [trino-419](https://repo1.maven.org/maven2/io/trino/trino-jdbc/419/trino-jdbc-419.jar).

...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/398/trino-cli-398-executable.jar)
```
...
The current deployment has been tested with [trino-398](https://repo1.maven.org/maven2/io/trino/trino-jdbc/398/trino-jdbc-398.jar).

...
Trino CLI can be acquired [here](https://repo1.maven.org/maven2/io/trino/trino-cli/420/trino-cli-420-executable.jar)
```
...
The current deployment has been tested with [trino-420](https://repo1.maven.org/maven2/io/trino/trino-jdbc/420/trino-jdbc-420.jar).
